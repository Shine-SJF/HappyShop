 ...
 * This class performs one-time file system setup and is not used by the
 * rest of the application at runtime.
 *
 * The same exception handling strategy as SetDatabase is used: methods
 * declare checked exceptions using 'throws' rather than handling them locally.
 * If an exception occurs, it is acceptable to propagate to the JVM.
 *
 * This keeps the setup code focused and readable for its standalone purpose.
 */
