...
public class Product implements Comparable<Product> {
    ...
    public Product(String id, String des, String image, double aPrice, int orderedQuantity, int stockQuantity) {
        proId = id;
        proDescription = des;
        proImageName = image;
        unitPrice = aPrice;
    ...
    public String toString() {
        String productInfo = String.format("Id: %s, £%.2f/unit, %s, \nstock: %d (last known)",
                          proId, unitPrice,proDescription, stockQuantity);
        return productInfo;
    }
